...
var exercisesCanvas = [ {  // First Exercise Object, usually an intro
	...
	html:"<canvas id='canvasWindow'></canvas>\n",
	...
	source: "// No source code required for the introduction \n" +
			"var c = document.getElementById('canvasWindow'); \n" +
			"var ctx = c.getContext('2d'); \n" +
			"ctx.moveTo(0,0); \n" +
			"ctx.lineTo(200,100); \n" +
			"ctx.stroke(); \n" +
			"printLn('Ok so here is some text to boot'); \n"	,
	runCode: function() { 
			code.run();
			return(true);
	}
